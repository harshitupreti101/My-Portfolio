    ...
    <div className='py-10 px-20 flex justify-between items-center'>
        <div className='flex flex-col gap-3'>
            ...
            <div className='flex gap-3'>
                <a href="https://github.com/harshitupreti101" target='_blank'><img className="h-4" src={githubIcon} alt="" /></a>
                <a href="https://www.linkedin.com/in/harshit-upreti-869b31247/" target='_blank'><img className="h-4" src={linkedinIcon} alt="" /></a>
                <a href="https://codeforces.com/profile/harshitupreti101" target='_blank'><img className="h-4" src={codeforcesIcon} alt="" /></a>
                <a href="https://leetcode.com/u/Harshit_Upreti/" target='_blank'><img className="h-4" src={leetcodeIcon} alt="" /></a>
            </div>
        </div>
